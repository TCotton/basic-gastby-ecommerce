...
const Iphone8 = () => {
  return (
    <div>
      <img
        src={require("../images/apple-iphone-8-plus-0.jpg")}
...
const IphoneX = () => {
  return (
    <div>
      <img
        src={require("../images/apple-iphone-x-new-1.jpg")}
        className="cart-image"
        alt="iphonex"
      />
...
const IphoneXS = () => {
  return (
    <div>
      <img
        src={require("../images/iphone-xs-img.jpg")}
        className="cart-image"
        alt="iphonexs"
      />
  ...
  render() {
    return (
      <div>
        ...
        <div>
          <Link to="/">
            <button className="btn btn-primary margin-button ">Back</button>
          </Link>
        </div>
